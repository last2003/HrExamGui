...
#
# Created: Mon Apr 14 21:37:45 2014
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.infoLabel = QtGui.QLabel(self.page_2)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QtGui.QApplication.translate("Form", "CCS HR 在线考试", None, QtGui.QApplication.UnicodeUTF8))
        self.statusLabel.setText(QtGui.QApplication.translate("Form", "TextLabel", None, QtGui.QApplication.UnicodeUTF8))
        self.userNameLabel.setText(QtGui.QApplication.translate("Form", "用户名:", None, QtGui.QApplication.UnicodeUTF8))
        self.passwordLabel.setText(QtGui.QApplication.translate("Form", "密码:", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("Form", "BY  CCSWZ 陈钧", None, QtGui.QApplication.UnicodeUTF8))
        self.loginButton.setText(QtGui.QApplication.translate("Form", "登录", None, QtGui.QApplication.UnicodeUTF8))
        self.infoLabel.setText(QtGui.QApplication.translate("Form", "提示信息", None, QtGui.QApplication.UnicodeUTF8))
